...
import batchCertificateRoutes from './routes/batchCertificate.routes';
import certificateRequestsRoutes from './routes/certificateRequests.routes';
...
app.use('/api/batch-certificates', batchCertificateRoutes);
app.use('/api/certificate-requests', certificateRequestsRoutes);
